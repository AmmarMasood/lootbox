...
$(function() {
  ...
  if (bgndKenburns.length) {
    bgndKenburns.vegas({
      ...
      slides: [
        { src: "../img/backgrounds/freestocks-org-65291-unsplash.jpg" },
        { src: "../img/backgrounds/kelly-sikkema-1490900-unsplash.jpg" },
        { src: "../img/backgrounds/gris-olmedo-542211-unsplash.jpg" }
      ],
  ...
  $(function() {
    $("#countdown").countdown({
      until: $.countdown.UTCDate(+10, 2019, 07, 10),
      format: "D"
    });
  });
  // --------------------------------------------- //
